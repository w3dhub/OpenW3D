...
elseif(UNIX AND NOT APPLE)
    ...
    find_package(X11)
    if(TARGET X11::X11)
        target_link_libraries(bgfx INTERFACE X11::X11)
    elseif(X11_X11_LIB)
        target_link_libraries(bgfx INTERFACE ${X11_X11_LIB})
    endif()
    foreach(X11_EXTENSION_TARGET X11::Xrandr X11::Xcursor)
        if(TARGET ${X11_EXTENSION_TARGET})
            target_link_libraries(bgfx INTERFACE ${X11_EXTENSION_TARGET})
        endif()
    endforeach()
