...
public:
	...
	GameObjCustomTimerClass( ScriptableGameObj *sender = nullptr, float time = 0, int type = 0, int param = 0 ) :
		RemainingTime( time ), Type( type ), Param( param)		{ if ( sender != nullptr ) Sender = sender; }
