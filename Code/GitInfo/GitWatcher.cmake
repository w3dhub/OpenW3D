...
function(GetGitState _working_dir)
    ...
    RunGitCommand(show -s "--format=%ad" "--date=format-local:%Y-%m-%d %H:%M:%S" ${object})
    if(exit_code EQUAL 0)
        set(ENV{GIT_AUTHOR_DATE} "${output}")
    endif()

    RunGitCommand(show -s "--format=%cn" ${object})
    if(exit_code EQUAL 0)
        set(ENV{GIT_COMITTER_NAME} "${output}")
    endif()
