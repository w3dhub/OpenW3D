...
#include "dx8texman.h"
#else
// Use stubs on other platforms (including Windows without DX9)
#include "dx8wrapper.h"
#endif
#include "TARGA.H"
 ...
 *=============================================================================================*/
void WW3D::Make_Screen_Shot( [[maybe_unused]] const char * filename_base )
{
#if !defined(_WIN32) || !defined(WW3D_DX9_BACKEND)
	WWASSERT(!IsRendering);
