...
public:
	...
	virtual RenderObjClass *	Clone(void) const override { return new DistLODClass(*this); }
	virtual int						Class_ID(void)	const override { return CLASSID_DISTLOD; }
...
public:
	...
	virtual int						Chunk_Type (void) override  { return W3D_CHUNK_LODMODEL; }
...
public:
	...
	virtual int						Get_Class_ID(void) const override	{ return RenderObjClass::CLASSID_DISTLOD; }
