...
DECLARE_SCRIPT(M01_TurretBeach_GDI_Guy_01_JDG, "")//
{
	...
	void Animation_Complete(GameObject * obj, const char *anim) override
	{
		if (openw3d::string_compare(anim, "S_A_Human.H_A_X1E_Run") == 0)
		{
			ActionParamsStruct params;
...
DECLARE_SCRIPT(M01_DetentionCiv_Air_Evac_Waypath_JDG, "")
{
	void Animation_Complete(GameObject * obj, const char *anim) override
	{
		if (openw3d::string_compare(anim, "XG_TransprtBone.XG_EV1_PathA") == 0)
		{
			Commands->Set_Animation ( obj, "XG_TransprtBone.XG_EV1_Pathloop", true , NULL, 0.0f, -1.0f, false);
		}

		else if (openw3d::string_compare(anim, "XG_TransprtBone.XG_EV1_PathZ") == 0)
		{
			Commands->Destroy_Object ( obj );
		}
	}
...
DECLARE_SCRIPT(M01_DetentionCiv_Air_Evac_Chopper_JDG, "")
{
	...
	void Animation_Complete(GameObject * obj, const char *anim) override
	{
		if (openw3d::string_compare(anim, "v_GDI_trnspt.XG_EV1_trnsA") == 0)
		{
		...
		else if (openw3d::string_compare(anim, "v_GDI_trnspt.XG_EV1_trnsz") == 0)
		{
			Commands->Destroy_Object ( obj );
		}
	}
...
DECLARE_SCRIPT(M01_ChurchArea_Air_Evac_Rope_JDG, "")
{
	...
	void Animation_Complete(GameObject * obj, const char *anim) override
	{
		if (openw3d::string_compare(anim, "XG_EV5_rope.XG_EV5_ropeZ") == 0)
		{
			Commands->Destroy_Object ( obj );
		}
	}
...
DECLARE_SCRIPT(M01_ChurchArea_Air_Evac_Waypath_JDG, "")
{
	...
	void Animation_Complete(GameObject * obj, const char *anim) override
	{
		if (openw3d::string_compare(anim, "XG_EV5_Path.XG_EV5_PathZ") == 0)
		{
			Commands->Destroy_Object ( obj );
		}
	}
...
DECLARE_SCRIPT(M01_Church_Priest_JDG, "")
{
	...
	void Animation_Complete(GameObject * obj, const char *anim) override
	{
		if (openw3d::string_compare(anim, "S_A_Human.XG_EV5_troop") == 0)
		{
			Commands->Destroy_Object ( obj );
		}
	}
...
DECLARE_SCRIPT(M01_Sinking_Gunboat_JDG, "")
{
	...
	void Animation_Complete(GameObject * obj, const char *anim) override
	{
		if (openw3d::string_compare(anim, "V_GDI_GBOAT.XG_GBOAT_SINK") == 0)
		{
			Commands->Destroy_Object ( obj );
		}
	}
...
DECLARE_SCRIPT(M01_Base_POW01_JDG, "")//116386
{
	...
	void Custom( GameObject * obj, int type, uintptr_t param, GameObject * sender ) override //M01_POW02_Conversation_01
	{
		ActionParamsStruct params;
