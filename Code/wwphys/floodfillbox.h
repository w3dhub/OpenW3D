	...
	public:
		...
		FloodfillBoxClass (void)
			:	m_Sector (nullptr),
				...
				m_GridLink (nullptr),
				m_Prev (nullptr),
				m_Next (nullptr)					{ ::memset (m_Neighbors, 0, sizeof (m_Neighbors));  }
...
FloodfillBoxClass::Is_Edge (void)
{
	...
	if (Peek_Neighbor (DIR_FORWARD) == nullptr ||
		 Peek_Neighbor (DIR_BACKWARD) == nullptr ||
		 Peek_Neighbor (DIR_LEFT) == nullptr ||
		 Peek_Neighbor (DIR_RIGHT) == nullptr) {
