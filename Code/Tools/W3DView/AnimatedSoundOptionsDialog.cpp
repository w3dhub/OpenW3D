...
AnimatedSoundOptionsDialogClass::OnInitDialog (void)
{
	...
	StringClass sound_def_lib_path	= static_cast<const char *>(theApp.GetProfileString ("Config", "SoundDefLibPath"));
	StringClass sound_ini_path			= static_cast<const char *>(theApp.GetProfileString ("Config", "AnimSoundINIPath"));
	StringClass sound_data_path		= static_cast<const char *>(theApp.GetProfileString ("Config", "AnimSoundDataPath"));
