...
//	Thread routines
//
typedef UINT (*MY_THREADPROC) (DWORD_PTR dwparam1, DWORD_PTR dwparam2, DWORD_PTR dwparam3, HRESULT *presult);
typedef UINT (*MY_UITHREADPROC) (DWORD_PTR dwparam1, DWORD_PTR dwparam2, DWORD_PTR dwparam3, HRESULT *presult, HWND *phmain_wnd);
void								Create_Worker_Thread (MY_THREADPROC fnthread_proc, DWORD_PTR dwparam1, DWORD_PTR dwparam2, DWORD_PTR dwparam3, HRESULT *presult);
