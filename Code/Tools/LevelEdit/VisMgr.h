...
class VisMgrClass
{
	public:
		...
		static void		Render_Manual_Vis_Points (bool farm_mode = false, int processor_index = 0, int total_processors = 1, VIS_POINT_RENDERED_CALLBACK callback = nullptr, DWORD_PTR param = 0);
