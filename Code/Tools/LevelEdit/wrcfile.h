...
*/
class WinResourceFileClass final : public FileClass
{
	public:
		WinResourceFileClass(char const *filename);
		WinResourceFileClass(HMODULE hmodule, char const *filename);
		virtual ~WinResourceFileClass(void);
