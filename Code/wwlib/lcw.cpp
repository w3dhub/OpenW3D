...
outofhere:
    ...
    const unsigned char *getp = static_cast<const unsigned char *>(source);
    unsigned char *putp = static_cast<unsigned char *>(dest);
    const unsigned char *getstart = getp;
    const unsigned char *getend = getp + datasize;
